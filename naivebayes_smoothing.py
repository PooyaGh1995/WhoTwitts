    ...
    def predict(self, X):
        ...
        for x in X:
            ...
            for word, _ in counts.items():
                ...
                log_w_given_m = math.log( (self.word_counts['m'].get(word, 0.0) + 1) / (sum(self.word_counts['m'].values()) + len(self.vocab)) )
                log_w_given_t = math.log( (self.word_counts['t'].get(word, 0.0) + 1) / (sum(self.word_counts['t'].values()) + len(self.vocab)) )
